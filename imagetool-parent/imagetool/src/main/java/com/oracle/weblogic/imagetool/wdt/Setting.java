...
import com.oracle.weblogic.imagetool.util.DBconnect;
...
public class Setting extends javax.swing.JFrame{
    ...
    public void p_update() {
        ...
        try {
        	if (DBconnect.isValid(l_name_update)&&DBconnect.isValid(f_name_update)) {
                String sql = "UPDATE person SET first_name='" + f_name_update + "', last_name='" + l_name_update +  "' WHERE id='" + getSessionID() + "'";
